...
public class BuildProject : MonoBehaviour
{
	...
	static string GetLocation()
	{
		...
		{
			throw new System.ArgumentException("Wrong content of environment value \"location\", please define a location for build result");
		}
		return location;
	}
	...
	static BuildTarget GetTarget()
	{
		...
		switch (System.Environment.GetEnvironmentVariable("target").ToLower())
		{
			...
			default:
				throw new System.ArgumentException("Wrong content of environment value \"target\", please define a build target platform");
		}
		return target;
	}
